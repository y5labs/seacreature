...
var changed, combine, contextcount, contexttime, copy, debounce, each, error, extend, filter, groupcount, grouptime, log, map, now, result, rollup, run, samplecount, sampletime, settle, split, stream, tagged, taggedall, taggedany, throttle, unit;
